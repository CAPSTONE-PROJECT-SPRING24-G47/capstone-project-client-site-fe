    ...
    <div className="outstanding-activity mb-8 rounded-md p-8 font-sans shadow-md">
      ...
      <div className="flex items-center">
        ...
        <div className=" ml-5 flex flex-grow flex-nowrap overflow-x-auto">
          {activities
            .slice(currentActivity, currentActivity + 4)
            .map((activity, index) => (
              <div key={index} className="relative mr-3 flex-shrink-0">
                <div className="activity-item rounded-md bg-gray-100 p-4 transition duration-300 hover:shadow-md">
                  ...
                  <div className="flex flex-col">
                    ...
                    <button className=" form-button ml-32 mt-4 rounded-xl bg-accent-color text-white hover:bg-white hover:font-bold hover:text-accent-color focus:outline-none ">
                      Xem chi tiết
                    </button>
                  </div>
                </div>
