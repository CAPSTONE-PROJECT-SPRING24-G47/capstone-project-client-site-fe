    ...
    <>
      {isPopUp && (
        <>
          ...
          >
            <button
              className="bg absolute right-3 top-3 z-[99] rounded-bl-lg rounded-tr-lg bg-secondary-color p-1 text-bg-color transition duration-100 ease-linear hover:-translate-y-1 hover:scale-110 hover:shadow-lg"
              onClick={handlePopUp}
            >
              <svg
