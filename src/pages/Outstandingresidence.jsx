  ...
  return (
    <div className="outstanding-residence mb-8 rounded-md p-8 font-sans shadow-md">
      ...
      <div className="flex items-center">
        {/* Nút lùi */}
        <button className="text-[#7398D5] hover:underline p-2" onClick={prevResidence}>
            ...
            <div key={index} className="flex-shrink-0 relative mr-3">
              <div className="activity-item rounded-md bg-gray-100 p-4 transition duration-300 hover:shadow-md">
                ...
                <div className="flex flex-col">
                  ...
                  <button className="ml-32 form-button mt-4 rounded-xl bg-[#7398D5] text-white hover:font-bold hover:bg-white hover:text-accent-color focus:outline-none ">
                    Xem chi tiết
                  </button>
                </div>
              </div>
        ...
        {/* Nút tiến */}
        <button className="text-[#7398D5] hover:underline p-2" onClick={nextResidence}>
