...
const Region = () => {
  ...
  return (
    <div className="flex mt-10 mb-10">
      <div className="rounded-3xl border-gray-300 border flex w-4/5 ml-36 bg-[#ededed] relative overflow-hidden">
        {/* Bên trái: Tiêu đề và Giới thiệu về vùng */}
        <div className="w-1/2 pl-10 bg-opacity-80">
          <div className="w-4/5 pt-3">
            <h1 className="text-3xl font-bold mb-4">Các vùng của Nhật Bản</h1>
            <ImageList images={images} />
            <div className=" text-sm pt-2 pl-2 pb-3 bg-[#282828] text-white">
